...
# --- Adjusted Configuration Parameters for Spoke 3 ---
VRF = "front-door"
INTERFACE = "G0/1"
IP_ADDR = "10.0.0.4"
...
OSPF_PROCESS = "1"
OSPF_AREA = "35"          # Area 35
OSPF_AREA_MODE = "nssa"   # Must match Hub 'area 35 nssa'

TUNNEL_INTERFACE = "Tunnel35"
TUNNEL_IP = "172.16.35.2" # Matches Hub Tunnel35 Subnet (.35.1 is Hub)
    ...
    try:
        with ConnectHandler(**device) as net_connect:
            config_commands = [
                ...
                # 8. OSPF Process (Adjusted for NSSA)
            ...
            print(f"Applying Spoke 3 config (Tunnel {TUNNEL_INTERFACE})...")
